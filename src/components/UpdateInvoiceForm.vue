<template>
  <Dialog v-model:visible="display2">
    ...
    <form>
      ...
      <div>
        ...
        <div class="added-projects">
          <div class="project-labels" v-show="projects.length > 0">
    ...
    <template #footer>
      ...
      <input v-model="remark" type="text" name="remark" id="remark" />
...
export default {
  ...
  methods: {
    ...
    submit() {
      ...
      axios({
        method: "put",
        url: process.env.VUE_APP_BASE_URL + "/invoice/" + this.invoice_id,
        headers: {
    ...
    showSuccess() {
      this.$toast.add({
        ...
        detail: "Invoice Updateded Successfully",
        life: 3000,
      });
    },
    showError() {
  ...
  props: ["display2", "invoice_id", "company", "date", "projects", "remark"],
};
</script>
